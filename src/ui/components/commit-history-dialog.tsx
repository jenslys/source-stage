...
export function CommitHistoryDialog({
  ...
  if (!open) return null
  const listVisibleRows = resolveVisibleRows(terminalHeight, 13)
  const commitVisibleRows = resolveDenseVisibleRows(listVisibleRows, 2)
  const actionVisibleRows = resolveDenseVisibleRows(listVisibleRows, 2)
                  ...
                  .map((option, visibleIndex) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <text fg={detailTextColor}> {fitLine(optionDescription, detailWidth)}</text>
                      </box>
                    )
                  })}
          </box>
